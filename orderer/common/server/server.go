...
// NewServer 基于广播目标和分类帐阅读器，创建一个ab.AtomicBroadcastServer 类型的广播服务器
//
// @Author: zhaoruobo
// @Date: 2023/11/15
func NewServer(
...
func (s *server) Deliver(srv ab.AtomicBroadcast_DeliverServer) error {
	...
	policyChecker := func(env *cb.Envelope, channelID string) error {
		...
		//在维护模式下，我们通常需要/Channel/Orderer/Readers的签名。
		//这将阻止来自对等体的交付请求(通常满足/Channel/Readers)。
