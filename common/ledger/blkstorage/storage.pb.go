...
// BootstrappingSnapshotInfo 包含有关引导快照的信息。
type BootstrappingSnapshotInfo struct {
	LastBlockNum         uint64   `protobuf:"varint,1,opt,name=lastBlockNum,proto3" json:"lastBlockNum,omitempty"`          // 最后一个区块的编号
	LastBlockHash        []byte   `protobuf:"bytes,2,opt,name=lastBlockHash,proto3" json:"lastBlockHash,omitempty"`         // 最后一个区块的哈希值
	PreviousBlockHash    []byte   `protobuf:"bytes,3,opt,name=previousBlockHash,proto3" json:"previousBlockHash,omitempty"` // 上一个区块的哈希值
	XXX_NoUnkeyedLiteral struct{} `json:"-"`                                                                                // 用于 JSON 序列化的占位符
	XXX_unrecognized     []byte   `json:"-"`                                                                                // 用于 JSON 序列化的占位符
	XXX_sizecache        int32    `json:"-"`                                                                                // 用于 JSON 序列化的占位符
}
