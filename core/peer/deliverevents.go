...
// DeliverServer 持有创建交付服务器所需的依赖关系。
type DeliverServer struct {
	DeliverHandler          *deliver.Handler            // 交付处理程序
	PolicyCheckerProvider   PolicyCheckerProvider       // 策略检查器提供者
	CollectionPolicyChecker CollectionPolicyChecker     // 集合策略检查器
	IdentityDeserializerMgr IdentityDeserializerManager // 身份反序列化管理器
}
