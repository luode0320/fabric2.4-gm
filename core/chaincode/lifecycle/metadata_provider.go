...
// NewMetadataProvider 返回一个新的metadatavrovider实例
func NewMetadataProvider(cip ChaincodeInfoProvider, lmp LegacyMetadataProvider, ccs ChannelConfigSource) *MetadataProvider {
	return &MetadataProvider{
		ChaincodeInfoProvider:  cip, // 链码信息提供者
		LegacyMetadataProvider: lmp, // 旧版元数据提供者
		ChannelPolicyReferenceProvider: &channelPolicyReferenceProviderImpl{ // 通道策略引用提供者
			ChannelConfigSource: ccs,
		},
	}
}

// MetadataProvider 提供元数据的提供者
type MetadataProvider struct {
	ChaincodeInfoProvider          ChaincodeInfoProvider          // 链码信息提供者
	LegacyMetadataProvider         LegacyMetadataProvider         // 旧版元数据提供者
	ChannelPolicyReferenceProvider ChannelPolicyReferenceProvider // 通道策略引用提供者
}
